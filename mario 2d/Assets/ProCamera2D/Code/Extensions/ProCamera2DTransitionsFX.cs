...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DTransitionsFX : BasePC2D
    {
        ...
        // Hack for changing just the Fade color without creating new materials
        public void ChangeTransitionColor(Color color)
        {
            BackgroundColorEnter = color;
            BackgroundColorExit = color;
        ...
        {
            BackgroundColorEnter = new Color32(0,0,0,255);
            BackgroundColorExit = new Color32(0, 0, 0, 255);
